...
#define ADSB_QUERY_MULT     1.4f           // feed query follows display range
#define ADSB_QUERY_MIN_KM   12.0f          // minimum feed query radius
#define ADSB_QUERY_MAX_KM   150.0f         // maximum feed query radius
