# Desk Radar — MakerWorld listing draft
...
> "Desk Radar" is too close for the listing title (a neutral title is safer).

---

## Title
**Desk Radar — Live Flight Radar Desk Gadget (ESP32-S3 Round AMOLED, Touch)**
...
Desk Radar turns a Waveshare round AMOLED dev board into a **live air-traffic
...
- 🔁 **On-screen zoom** button (10–100 km) and a **web config page** at
  `deskradar.local` (centre point, range, theme, brightness, sound, dim timer).
...
3. **Back plate / lid** — engraved "Desk Radar" logo on the outside.
